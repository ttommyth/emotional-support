...
/**
 * Watches the command file written by the MCP server and forwards commands
 * to a {@link RobotControlTarget} (the pet view provider). Also publishes
 * the current robot state to a state file consumed by the MCP server.
 */
